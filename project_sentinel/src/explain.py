...
_FEATURE_DISPLAY_NAMES: dict[str, str] = {
    ...
    "delta_Cr": "Creatinine change (12h)",
    ...
    "cr_ratio_baseline": "Creatinine / baseline ratio",
    "bun_cr_ratio": "BUN/Creatinine ratio",
    "wbc_lactate_product": "WBC × Lactate product",
    "anion_gap_proxy": "Anion gap (proxy)",
    "renal_perf_pressure": "Renal perfusion pressure (MAP)",
    "map_cr_velocity_interaction": "MAP × creatinine velocity",
    ...
    "O2Sat": "Oxygen saturation (SpO₂)",
    "Temp": "Body temperature",
    "Resp": "Respiratory rate",
    "Platelets": "Platelet count",
    "Potassium": "Potassium",
    "hours_since_sepsis": "Hours since sepsis onset",
    "Age": "Age",
    "Gender": "Gender",
}
